...
export default class AddSpecialToolRequest extends Component {
    constructor(props) {
        super(props);
        this.state = {
            gencode: "",
    ...
    async fetchData() {
        await AsyncStorage.getItem('Login_token')
            .then((token) => {
                fetch(GLOBALS.SERVICE_URL + '/getDetailHeaderAddSpecialdRequest.php', {
                    method: 'POST',
                    headers: {
                ...
                <Header style={{ backgroundColor: '#FFFFFF' }}>
                    ...
                    >
                        <Title
                            style={styles.title}
                        >
                            เพิ่มใบร้องขอสั่งซื้อสินค้าทดลองพิเศษ
                        </Title>
                    </Body>
                    <Right
                        style={{ flex: 0.1 }}
                    ...
                    <View style={styles.ViewBody}>
                        ...
                        <View style={styles.BoxlistItem}>
                            <View style={{ flex: 1, flexDirection: 'row' }}>
                                ...
                                >
                                    ประเภทใบร้องขอสั่งซื้อสินค้าทดลองพิเศษ / SPTR Code
                                </Text>
