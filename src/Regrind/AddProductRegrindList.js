...
var products = [];
export default class AddProductRegrindList extends Component {
    constructor(props) {
        super(props);
        const dataRG = this.props.navigation.getParam('dataRG', '0')
    ...
    onPress() {
        this.props.navigation.navigate('AddProductRegrind', { onSelect: this.onSelect });
    };
    goDetail() {
        this.props.navigation.navigate('AddRegrindDetail', { dataProduct: this.state.check, dataRG: this.state.dataRG });
    }
            ...
            <TouchableHighlight underlayColor="#03A9F4">
                <View style={styles.listItem}>
                    ...
                    <View style={styles.listItemContent}>
                        ...
                        <View style={styles.listItemContentRow}>
                            <Text style={styles.listItemContentName}> {rowData.textProductRemark} </Text>
                        </View>
                    </View>
                </View>
            </TouchableHighlight>
