...
import Trest from './Test'
var products = [];
export default class AddProductStandardRequest extends Component {
    constructor(props) {
        super(props);
    ...
    onPress() {
        this.props.navigation.navigate('AddProduct', { onSelect: this.onSelect });
    };
    goDetail() {
        this.props.navigation.navigate('AddStandardToolRequestDetail', { dataProduct: this.state.check, dataSTR: this.state.dataSTR });
    }
